...
jQuery(function(a) {
    function d(f) {
        ...
        a(c.BASE).each(function() {
            a(this).is(c.FIXED_TOP) && (a(this).is(c.TRANSPARENT) && !a(this).hasClass(b.OPENED) && (0 < d ? a(this).removeClass(b.BG_COLOR) : a(this).addClass(b.BG_COLOR)), 0 < d ? a(this).addClass(b.SHORT) : a(this).removeClass(b.SHORT))
        })
    }
    var b = {
            IN: "in",
        ...
        e;
    a(window).on("scroll.bs.navbar-dropdown.data-api resize.bs.navbar-dropdown.data-api",
        function(a) {
            clearTimeout(e);
    ...
    a(document).on("click.bs.navbar-dropdown.data-api", c.BASE,
        function(a) {
